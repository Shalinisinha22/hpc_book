...
export default function GalleryPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <Sidebar className="hidden md:flex" activeItem="Gallery" />
      ...
      <div className="flex-1">
        ...
        <main className="p-4 md:p-6">
          <div className="bg-gold p-4 md:p-6 rounded-t-lg flex justify-between items-center">
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-white">Rooms & Suites Gallery</h1>
              <div className="flex items-start mt-2 text-white">
                <Info className="h-5 w-5 mr-2 flex-shrink-0 mt-0.5" />
                <p className="text-sm">Manage your room photos here. You can add new photos or delete existing ones.</p>
              </div>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50 text-left">
                    ...
                    <th className="px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Room Type</th>
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Add Rooms Photos</DialogTitle>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button className="bg-gold hover:bg-gold-dark" onClick={handleSave}>
              Save
            </Button>
          </DialogFooter>
        </DialogContent>
